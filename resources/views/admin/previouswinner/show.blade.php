                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th> Image </th>
                                    <td>
                                        <?php if (file_exists(public_path(App\Http\Controllers\Admin\CompetitionController::$_mediaBasePath . $previouswinner->image))): ?>
                                            <img width="50" src="<?= url(App\Http\Controllers\Admin\CompetitionController::$_mediaBasePath . $previouswinner->image) ?>">
                                        <?php else: ?>
                                                           <!--<span>-</span>-->
                                            <img width="50" src="<?= url('noimage.png'); ?>">
                                        <?php endif; ?>    
